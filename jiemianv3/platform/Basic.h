/*
author£ºDarkTheCross
time£º2012/6/30 21:41
...
namespace DS14
{
	...
	const int HP_RECOVERY_PER_STRENTH = 0.05;
	const int MISSILE_RANGE_PER_STRENTH = 3;
	const int MISSLE_DAMAGE_PER_STENTH = 0.05;
	...
	typedef struct playercommand
	{
		...
		UpdateScience updateScience[MAX_UPDATE_NUMBER_PER_ROUND];
	}PlayerCommand;

    //info of ai   Æ½Ì¨×éÌí 2012.7.22
